...
Main_:CreateButton(
	"Achromatic",
	"Shadow Blademasters Blade, Blademasters Blade",
	"Golden Demonic Greatsword, Corrupt Demonic Greatsword",
	"Frozen Demonic Greatsword, Demonic Greatsword",
	"",
	"",
	function()
...
Main_:CreateButton(
	"Boobs",
	"Motocross #62: Fire",
	"Motocross #77: The Sting",
	"Pink Ornament Earrings",
	"",
	"",
	function()
...
Main_:CreateButton("FIXED Gale Fighter", "None", "", "", "", "", function()
	loadstring(game:HttpGetAsync("https://pastebin.com/raw/5jBTETjn"))()
end)

Main_:CreateButton("Gale Fighter", "Type-37 Pulse Rifle", "Miami Sunshine Slugger", "", "", "", function()
	loadstring(game:HttpGetAsync("https://pastebin.com/raw/JyeTUxvS"))()
end)
